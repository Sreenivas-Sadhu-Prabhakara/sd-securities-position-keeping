package com.bank.bian.securitiespositionkeeping.model;
...
/**
 * The BIAN control record for this service domain: "Securities Position Maintenance Agreement".
 *
 ...
 * to its asset type (Securities Position). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Securities Position Maintenance Agreement";
